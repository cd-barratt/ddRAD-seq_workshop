...
This is all done in the EVE cluster, you can make your own scripts to do this or use the one provided. It can be submitted via sbatch in the EVE cluster, but be sure to modify the email address #and output paths to your own details.
