...
output = ped2geno('/Users/cb76kecu/Desktop/ddRAD-seq_workshop/outputs/Exercise_5/sNMF/Lflav.ped')
geno <- read.geno('/Users/cb76kecu/Desktop/ddRAD-seq_workshop/outputs/Exercise_5/sNMF/Lflav.geno') 
```
...
k_range <- 1:10
geno.snmf <- snmf(('/Users/cb76kecu/Desktop/ddRAD-seq_workshop/outputs/Exercise_5/sNMF/Lflav.geno'), K = k_range, entropy = T, ploidy = 2, rep=5, project = 'new')  
```
