...
plink --file ~/work/ddRAD-seq_workshop/data/Exercises_4-8/Admixture/Lflav --make-bed --recode --out ~/work/ddRAD-seq_workshop/outputs/Exercise_4/

#run admixture
cd ~/work/ddRAD-seq_workshop/outputs/Exercise_4/
bash
