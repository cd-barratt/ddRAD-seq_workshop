...
DATA_PATH=~/work/ddRAD-seq_workshop/data/Exercise_1/
...
### On your own...  
If you want to investigate this further at some point you can try it yourself for barcodes_2, barcodes_3, barcodes_4, barcodes_5, barcodes_6 (files are supplied in the ```~/work/ddRAD-seq_workshop/data/Exercise_2/``` directory). Each time running process_radtags will search for the individuals identified by the relevant barcodes that you supply.
