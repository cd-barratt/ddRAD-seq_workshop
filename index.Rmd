...
### Installation
Please run the following code (just copy it into the RStudio console) before the course to make sure all R packages are installed
```
install.packages(c("XXXXXXXX"))
