...
populations -P /work/$USER/ddRAD-seq_workshop/data/Exercises_4-8/FST_genetic_diversity/ -O /work/$USER/ddRAD-seq_workshop/data/Exercises_4-8/FST_genetic_diversity/ -M /work/$USER/ddRAD-seq_workshop/data/Exercises_4-8/FST_genetic_diversity/Lflav_popmap -t 1 -p 4 -r 0.8 --genepop --fstats --min-maf 0.05
